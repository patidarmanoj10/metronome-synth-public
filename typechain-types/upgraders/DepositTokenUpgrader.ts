...
export interface DepositTokenUpgraderInterface extends utils.Interface {
  functions: {
...
export interface DepositTokenUpgrader extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DepositTokenUpgraderInterface;
