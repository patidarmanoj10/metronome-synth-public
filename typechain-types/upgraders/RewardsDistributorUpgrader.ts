...
export interface RewardsDistributorUpgraderInterface extends utils.Interface {
  functions: {
...
export interface RewardsDistributorUpgrader extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardsDistributorUpgraderInterface;
