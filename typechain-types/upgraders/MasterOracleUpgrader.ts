...
export interface MasterOracleUpgraderInterface extends utils.Interface {
  functions: {
...
export interface MasterOracleUpgrader extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MasterOracleUpgraderInterface;
