...
export interface DebtTokenUpgraderInterface extends utils.Interface {
  functions: {
...
export interface DebtTokenUpgrader extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DebtTokenUpgraderInterface;
