...
export interface ControllerUpgraderInterface extends utils.Interface {
  functions: {
...
export interface ControllerUpgrader extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ControllerUpgraderInterface;
