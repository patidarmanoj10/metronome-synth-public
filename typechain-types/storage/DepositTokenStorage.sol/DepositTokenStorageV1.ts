...
export interface DepositTokenStorageV1Interface extends utils.Interface {
  functions: {
...
export interface DepositTokenStorageV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DepositTokenStorageV1Interface;
