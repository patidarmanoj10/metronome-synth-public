...
export interface DebtTokenStorageV1Interface extends utils.Interface {
  functions: {
...
export interface DebtTokenStorageV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DebtTokenStorageV1Interface;
